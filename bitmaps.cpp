...
void LoadBitmaps(Bitmaps_t &Bitmaps, ElementsOfScreen_t ElementsOfScreen){
	/*Wczytanie bitmap*/
	Bitmaps.ball = SDL_LoadBMP(".Bitmaps/ball.bmp");
	...
	for (int BlockNumber = 0; BlockNumber < 7; BlockNumber++){
		char  BlockFileName[] = ".Bitmaps/block1.bmp";
	...
	for (int PaddleNumber = 0; PaddleNumber < 8; PaddleNumber++){
		char  PaddleFileName[] = ".Bitmaps/Paddle1.bmp";
	...
	Bitmaps.background = SDL_LoadBMP(".Bitmaps/background.bmp");
